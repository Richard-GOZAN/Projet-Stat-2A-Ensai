...
du suivi médical nécessaire à leur prise en charge \cite{statcan2022}.
...
\cite{bag2024}. En revanche, les hommes, notamment dans les catégories
...
permettant de réduire les coûts associés aux soins \cite{bvs2023}. À
...
entraîne un recours plus fréquent aux soins médicaux \cite{bvs2023}. En
...
\cite{statcan2022}. Par ailleurs, l'accès à un médecin traitant ou de
...
médicales \cite{statcan2022}. Enfin, les inégalités spatiales dans
...
constituent des freins majeurs \cite{irdes2020}.
