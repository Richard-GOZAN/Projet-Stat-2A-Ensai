...
## Estimation de l'Effet Aléatoire $v_i$ dans une Agglomération Donnée
...
### 1. Définition de l'Effet Aléatoire $v_i$
...
### 1. Approche de Maximum de Vraisemblance (ML)
...
### 4. Utilisation des Effets Aléatoires
...
## Modèles de Régressions de Poisson
...
### 1. Régression Poisson avec Effets Aléatoires Non Spatiaux
...
### 2. Régression Poisson avec Effets Aléatoires Spatiaux Basés sur la Distance
...
### 3. Régression Poisson avec Effets Aléatoires Spatiaux Basés sur le Voisinage
