...
$$\tau_i = \frac{n_i}{P_i}$$
où $\tau_i$ et $\n_i$ sont respectivement le taux et le nombre de visite de la commune $i$. 
...
(Voirt aussi le taux avec les enfants et aussi suivant le sexe si possibel comparer voir entre garcon et femmes qui se consultent le plus en matière de poiuyrcentage. )
...
```{r fig.cap="Densité des distances", fig.align='center'}
