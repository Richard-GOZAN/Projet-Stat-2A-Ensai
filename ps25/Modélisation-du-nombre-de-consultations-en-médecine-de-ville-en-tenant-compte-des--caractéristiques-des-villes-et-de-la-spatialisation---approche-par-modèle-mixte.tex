...
\hypersetup{
  pdftitle={Modélisation du nombre de consultations en médecine de ville en tenant compte des caractéristiques des villes et de la spatialisation : approche par modèle mixte},
  pdfauthor={Groupe 25},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\title{Modélisation du nombre de consultations en médecine de ville en
tenant compte des caractéristiques des villes et de la spatialisation :
...
\chapter{\texorpdfstring{\textcolor{brown} {Introduction=""}}{}}\label{section-1}
...
\chapter{\texorpdfstring{\textcolor{brown} {Présentation="" du="" contexte=""}}{}}\label{section-2}
...
du suivi médical nécessaire à leur prise en charge \citep{statcan2022}.
...
\citep{bag2024}. En revanche, les hommes, notamment dans les catégories
...
permettant de réduire les coûts associés aux soins \citep{bvs2023}. À
...
entraîne un recours plus fréquent aux soins médicaux \citep{bvs2023}. En
...
\citep{statcan2022}. Par ailleurs, l'accès à un médecin traitant ou de
...
médicales \citep{statcan2022}. Enfin, les inégalités spatiales dans
...
constituent des freins majeurs \citep{irdes2020}.

\bookmarksetup{startatroot}

\chapter{\texorpdfstring{\textcolor{brown} {Méthodologie=""}}{}}\label{section-3}
...
\chapter{\texorpdfstring{\textcolor{brown} {Analyse="" des="" résultats=""}}{}}\label{section-4}
...
{\centering \includegraphics{analyse_descriptive_files/figure-pdf/unnamed-chunk-3-1.pdf}
...
{\centering \includegraphics{analyse_descriptive_files/figure-pdf/unnamed-chunk-5-1.pdf}
...
{\centering \includegraphics{analyse_descriptive_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
{\centering \includegraphics{analyse_descriptive_files/figure-pdf/unnamed-chunk-9-1.pdf}
...
{\centering \includegraphics{analyse_descriptive_files/figure-pdf/unnamed-chunk-12-1.pdf}
...
\chapter{Modélisation}\label{moduxe9lisation-1}
...
\end{figure}
  ...
  \bibliography{references.bib,mabiblio.bib}
